...
export class FormComponent implements OnInit {
  ...
  semesters: string[] = ['Semester 1', 'Semester 2']; // Hardcoded semesters
  types: string[] = ['Mid1', 'Mid2', 'Final'];
  sessions: string[] = ['Spring', 'Summer', 'Fall', 'Winter']; // Example values
  ...
  confirmUpload() {
    if (this.myForm.valid && this.selectedFile) {
      ...
      // Now call the uploadPastpaper with both formData and selectedFile

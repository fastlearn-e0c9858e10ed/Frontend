...
export class FormComponent implements OnInit {
  ...
  onSubmit() {
    if (this.myForm.valid && this.selectedFile) {
      ...
      formData.append('type', this.myForm.get('type')?.value); // Use form control value
      formData.append('session', this.myForm.get('session')?.value); // Use form control value
      formData.append('semester', this.myForm.get('semester')?.value); // Use form control value
